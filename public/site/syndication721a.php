...
<feed xmlns="http://www.w3.org/2005/Atom" xmlns:dc="http://purl.org/dc/elements/1.1/">
	<title type="html"><![CDATA[HUDS.TF - Guide]]></title>
	...
	<updated>2023-01-29T13:16:03Z</updated>
	<generator uri="http://www.mybb.com">MyBB</generator>
	<entry xmlns="http://www.w3.org/2005/Atom">
		<published>2020-08-03T01:00:09Z</published>
		<updated>2020-08-03T01:04:16Z</updated>
		<link rel="alternate" type="text/html" href="https://huds.tf/site/s-Creating-a-Custom-Video-Intro-for-Team-Fortress-2" />
		<id>https://huds.tf/site/s-Creating-a-Custom-Video-Intro-for-Team-Fortress-2</id>
		<title type="html" xml:space="preserve"><![CDATA[Creating a Custom Video Intro for Team Fortress 2]]></title>
		<content type="html" xml:space="preserve" xml:base="https://huds.tf/site/s-Creating-a-Custom-Video-Intro-for-Team-Fortress-2"><![CDATA[<span style="font-size: large;">I was messing around with the TF2 files and stumbled across how the game chooses it’s intro video to play on launch. I was interested to see if I could make a Custom Intro, and it turns out it’s really easy.<br />
<br />
Here’s how:</span><br />
<br />
...
<br />
Inside this folder, copy your .bik file into it, and create a file called startupvids.txt. Inside this file, you’ll only need one line of text, which is media/&#x26;tFILENAME&#x26;t.bik, where &#x26;tFILENAME&#x26;t is, obviously, the name of your file. <span style="font-style: italic;">(examples below)</span><br />
...
<br />
<span style="font-weight: bold;">SIDE NOTE:</span> you don’t have to put this into a Custom HUD folder. You can make a separate Custom folder for your intro video to live in individually, so it will run on every Custom HUD you use, or even on the default TF2 HUD, similar to the way you would do a hitsound. tf/custom/introvideo/media/ and then your files would work.]]></content>
		<draft xmlns="http://purl.org/atom-blog/ns#">false</draft>
	</entry>
	<entry xmlns="http://www.w3.org/2005/Atom">
		<published>2020-03-11T19:08:13Z</published>
		<updated>2020-03-11T19:35:17Z</updated>
		<link rel="alternate" type="text/html" href="https://huds.tf/site/s-In-Depth-HUD-Crosshair-Guide" />
		<id>https://huds.tf/site/s-In-Depth-HUD-Crosshair-Guide</id>
		<title type="html" xml:space="preserve"><![CDATA[In-Depth HUD Crosshair Guide]]></title>
		<content type="html" xml:space="preserve" xml:base="https://huds.tf/site/s-In-Depth-HUD-Crosshair-Guide"><![CDATA[<span style="font-size: x-large;">This guide has been ported over from the old HUDS.TF Guides section. Credit for this Guide goes towards <a href="https://huds.tf/forum/member.php?action=profile&amp;uid=44" target="_blank">Komorebi</a>.</span><br />
<br />
...
This stands for foreground color and is the color that you will see your text as. The syntax for this parameter is &#x26;t R G B A &#x26;t, with R meaning Red, G being Green, B being Blue, and A being Alpha. Alpha determines how transparent the color is, but it sometimes doesn’t function correctly in TF2 for custom crosshair fonts, not sure why. For setting the colors, the accepted values are any integer from zero to two hundred fifty five. Each number determines how much of that color is present. So, &#x26;t 255 0 0 255 &#x26;t would mean the text will be all red, &#x26;t 255 255 0 255 &#x26;t would mean the text would be equal parts red and green and so would manifest itself as yellow. You don’t need to put in any ‘&#x26;t’s, I simply put them in to separate the values from the text. Make sure it is surrounded by parentheses. You can also simply reference the name of a color which is installed in <span style="font-weight: bold;">ClientScheme.res</span>, here’s the definition for ‘White’, which I used in the example, in ClientScheme. Colors are defined at the beginning. As you can see all colors are defined by the code I explained above.<br />
<br />
<div class="codeblock">
<div class="title">Code:<br />
...
<li>First, go to file&#x26;tnew to create a new file. You are going to want your dimensions to be a power of 2 by another power of 2.<br />
...
<li>First off, whenever you are using a tool it's a good idea to have the "Tool Options" window open. If you don't see it go up to Windows&#x26;tDockable Dialogs&#x26;tTool Options. This is extremely useful.<br />
</li>
...
<li>Another useful trick for selecting by color is that if there is an image and you want to effectively get rid of a inform background you can select the background then hit Edit&#x26;tClear to send it to transparent or Select&#x26;tInvert to invert the selection, effectively selecting every pixel in the image that is NOT the color you selected. The invert selection button is immensely useful in multiple other ways as well.<br />
</li>
...
<br />
Your next task is to create a .vmt file to accompany your .vtf. I The .vmt is just a text document that lets the game know how to use the .vtf. It is the vmt file that the game actually looks at, not the .vtf.  personally don't use VTFedit's function to create your own .vmt as I do it by hand but you certainly can do so if you wish. It is under Tools&#x26;tCreate VMT File. If you use it you simply select your saved .vtf as the base texture. If you wish to do it by hand, simply make a new text document and paste this in:<br />
<br />
<div class="codeblock">
<div class="title">Code:<br />
</div><div class="body" dir="ltr"><code>"UnlitGeneric"<br />
...
<br />
As far as usage of this guide goes: use it however/whenever you wish! Please feel to post corrections if I've made a mistake or suggest improvements that could be made.]]></content>
		<draft xmlns="http://purl.org/atom-blog/ns#">false</draft>
	</entry>
	<entry xmlns="http://www.w3.org/2005/Atom">
		<published>2020-03-11T19:03:52Z</published>
		<updated>2020-03-11T19:35:31Z</updated>
		<link rel="alternate" type="text/html" href="https://huds.tf/site/s-Keeping-your-HUD-Animations-up-to-date-using-hudanimations-manifest-txt" />
		<id>https://huds.tf/site/s-Keeping-your-HUD-Animations-up-to-date-using-hudanimations-manifest-txt</id>
		<title type="html" xml:space="preserve"><![CDATA[Keeping your HUD Animations up to date using hudanimations_manifest.txt]]></title>
		<content type="html" xml:space="preserve" xml:base="https://huds.tf/site/s-Keeping-your-HUD-Animations-up-to-date-using-hudanimations-manifest-txt"><![CDATA[Having a hudanimations_tf.txt file in your custom HUD has proved somewhat of a hassle in TF2 updates. It's the primary cause of most in-game crashes and bugs. Even an update that doesn't change much in the way of actual HUD elements could cause a problem if the hudanimations_tf file is outdated.<br />
<br />
...
<br />
If you're still stuck, comment below and I'll try to help you out as best I can.]]></content>
		<draft xmlns="http://purl.org/atom-blog/ns#">false</draft>
	</entry>
	<entry xmlns="http://www.w3.org/2005/Atom">
		<published>2020-03-11T18:57:40Z</published>
		<updated>2020-03-11T19:35:39Z</updated>
		<link rel="alternate" type="text/html" href="https://huds.tf/site/s-HUD-Installation-for-Linux" />
		<id>https://huds.tf/site/s-HUD-Installation-for-Linux</id>
		<title type="html" xml:space="preserve"><![CDATA[HUD Installation for Linux]]></title>
		<content type="html" xml:space="preserve" xml:base="https://huds.tf/site/s-HUD-Installation-for-Linux"><![CDATA[<span style="font-size: large;"><span style="font-weight: bold;">This is the Installation Guide for the Linux Operating System</span></span><br />
...
<br />
<span style="font-weight: bold;">Still having issues?</span> Feel free to post any problems you are having below.]]></content>
		<draft xmlns="http://purl.org/atom-blog/ns#">false</draft>
	</entry>
	<entry xmlns="http://www.w3.org/2005/Atom">
		<published>2020-03-11T18:56:40Z</published>
		<updated>2020-03-11T19:35:46Z</updated>
		<link rel="alternate" type="text/html" href="https://huds.tf/site/s-HUD-Installation-for-Mac" />
		<id>https://huds.tf/site/s-HUD-Installation-for-Mac</id>
		<title type="html" xml:space="preserve"><![CDATA[HUD Installation for Mac]]></title>
		<content type="html" xml:space="preserve" xml:base="https://huds.tf/site/s-HUD-Installation-for-Mac"><![CDATA[<span style="font-size: large;"><span style="font-weight: bold;">This is the Installation Guide for the Mac Operating System</span></span><br />
...
<span style="font-weight: bold;">Still having issues?</span> Feel free to post any problems you are having below.]]></content>
	...
	<entry xmlns="http://www.w3.org/2005/Atom">
		<published>2020-03-11T18:54:32Z</published>
		<updated>2020-03-11T19:36:19Z</updated>
		<link rel="alternate" type="text/html" href="https://huds.tf/site/s-HUD-Installation-for-Windows" />
		<id>https://huds.tf/site/s-HUD-Installation-for-Windows</id>
		<title type="html" xml:space="preserve"><![CDATA[HUD Installation for Windows]]></title>
		<content type="html" xml:space="preserve" xml:base="https://huds.tf/site/s-HUD-Installation-for-Windows"><![CDATA[<span style="font-size: large;"><span style="font-weight: bold;">This is the Installation Guide for the Windows Operating System</span></span><br />
<a href="http://huds.tf/forum/showthread.php?tid=1988" target="_blank">Click here for the Mac Installation Guide</a><br />
